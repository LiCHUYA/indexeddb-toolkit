...
function useDatabase(dbName) {
    var _this = this;
    if (!dbName) {
        return index_1.default.DBNAME_IS_NULL();
    }
    var request = window.indexedDB.open(dbName);
    return new Promise(function (resolve, reject) {
        request.onsuccess = function (event) {
            resolve(index_1.default.OPEN_DB_SUCCESS(event));
        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 3];
                    case 2:
                        resolve(index_1.default.OPEN_DB_ERROR(event.target.error));
                        _a.label = 3;
                    case 3: return [3 /*break*/, 5];
                    case 4:
                        error_1 = _a.sent();
                        reject(index_1.default.BASIC_ERROR(event.target.error));
                        return [3 /*break*/, 5];
