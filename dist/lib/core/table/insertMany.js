...
function insertMany(dbName, tableName, data) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!Array.isArray(data)) {
                        return [2 /*return*/, constant_1.default.INSERT_DATA_ERROR(data)];
                    }
                                ...
                                try {
                                    ...
                                    for (_i = 0, data_1 = data; _i < data_1.length; _i++) {
                                        ...
                                        request.onsuccess = function (event) {
                                            resolve(constant_1.default.TB_INSERT_MANY_SUCCESS(event));
                                        };
