        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    tableExist = _a.sent();
                    if (!tableExist) {
                        return [2 /*return*/, constant_1.default.TB_NOTFOUND("".concat(tableName, " \u8868\u4E0D\u5B58\u5728"))];
                    }
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                            ...
                            var deletePromises = keys.map(function (key) {
                                return new Promise(function (resolve, reject) {
                                    ...
                                    request.onerror = function (event) {
                                        return reject(constant_1.default.TB_DELETE_RECORDS_BY_KEYS_ERROR(event.target.error));
                                    };
                                });
                            });
                            Promise.all(deletePromises)
                                .then(function () {
                                return resolve(constant_1.default.TB_DELETE_RECORDS_BY_KEYS_SUCCESS("".concat(keys.length, " \u6761\u6570\u636E\u5220\u9664\u6210\u529F")));
                            })
                                .catch(function (error) { return reject(constant_1.default.TB_DELETE_RECORDS_BY_KEYS_ERROR(error)); });
                        })];
                case 4:
                    error_1 = _a.sent();
