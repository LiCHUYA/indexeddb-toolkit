...
var ResponseMessages = {
    ...
    // 表操作相关
    TB_CREATE_SUCCESS: function (data) { return returnFormatter(200, '表创建成功', __assign(__assign({}, data), { timestamp: Date.now() })); },
...
var logger = {
    debug: function () {
        ...
        if (!isProduction()) {
            console.debug.apply(console, __spreadArray(['[IndexedDB Toolkit]'], args, false));
        }
    },
    error: function () {
        var args = [];
        ...
        if (!isProduction()) {
            console.error.apply(console, __spreadArray(['[IndexedDB Toolkit]'], args, false));
        }
    },
    warn: function () {
        var args = [];
        ...
        if (!isProduction()) {
            console.warn.apply(console, __spreadArray(['[IndexedDB Toolkit]'], args, false));
        }
    }
};
...
function useDatabase(dbName, version) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        var handleVersionError = function (dbName, error) { return __awaiter(_this, void 0, void 0, function () {
...
function createTable$$1(dbName_1, tableName_1) {
    return __awaiter(this, arguments, void 0, function (dbName, tableName, options) {
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            if (!(keyPath in data)) {
                                if (!store.autoIncrement) {
                                    finalData = __assign((_a = {}, _a[keyPath] = Date.now(), _a), data);
                                }
                                else {
                                    finalData = data;
                                }
...
function insertMany$$1(dbName_1, tableName_1, data_1) {
    return __awaiter(this, arguments, void 0, function (dbName, tableName, data, options) {
                                    ...
                                    case 0:
                                        ...
                                        if (!(keyPath in item)) {
                                            if (!store_1.autoIncrement) {
                                                finalData_1 = __assign((_a = {}, _a[keyPath] = Date.now(), _a), item);
                                            }
                                            else {
                                                finalData_1 = item;
                                            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    database_1 = _a.sent();
                    result = [];
                    queryTableData_1 = function (storeName) { return __awaiter(_this, void 0, void 0, function () {
                ...
                case 5:
                    ...
                    tableDataPromises = objectStoreNames.map(function (storeName) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
...
function saveFilesToDB(dbName_1, tableName_1, file_1) {
    return __awaiter(this, arguments, void 0, function (dbName, tableName, file, options) {
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    fileData_1 = {
                        ...
                        rawFileInfo: __assign(__assign({}, baseInfo), { file: file, blob: file, url: URL.createObjectURL(file) }),
                        handleFileInfo: __assign(__assign({}, baseInfo), { url: URL.createObjectURL(file) })
                    };
...
function generateThumbnail(file_1, size_1) {
    return __awaiter(this, arguments, void 0, function (file, size, compress) {
...
function getFileFromDB(dbName_1, tableName_1, fileId_1) {
    return __awaiter(this, arguments, void 0, function (dbName, tableName, fileId, options) {
        var db, transaction, store_1, error_1;
...
function migrateData(fromDB_1, toDB_1) {
    return __awaiter(this, arguments, void 0, function (fromDB, toDB, options) {
...
function exportToJson(dbName_1) {
    return __awaiter(this, arguments, void 0, function (dbName, options) {
...
function importFromJson(dbName_1, jsonData_1) {
    return __awaiter(this, arguments, void 0, function (dbName, jsonData, options) {
...
export { useDatabase, deleteTable, deleteDatabase, deleteAllDatabases, closeAllConnections$1 as closeAllConnections, getTableNames, deleteAllTables$$1 as deleteAllTables, createTable$$1 as createTable, insertOne$$1 as insertOne, insertMany$$1 as insertMany, findDBData$$1 as findDBData, findByKey$$1 as findByKey, findByIndex$$1 as findByIndex, deleteOneByPk$$1 as deleteOneByPk, deleteOneByIndex$$1 as deleteOneByIndex, deleteManyByPK$$1 as deleteManyByPK, deleteManyByIndex$$1 as deleteManyByIndex, updateDataByPrimaryKey$$1 as updateDataByPrimaryKey, updateDataByIndex$$1 as updateDataByIndex, createQuery, saveFilesToDB, getFileFromDB, getAllFiles, downloadFileFromDB, downloadAllFiles, revokeFileUrl, generateFileShortId$1 as generateFileShortId, createFileDownloadToken, migrateData, exportToJson, importFromJson };
//# sourceMappingURL=indexeddb-toolkit.es5.js.map
